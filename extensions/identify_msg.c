...
static const char identify_msg_desc[] = "Provides the foxcomet.chat/identify-msg client capability";

static void identmsg_outbound(void *);
unsigned int CLICAP_IDENTIFY_MSG = 0;

mapi_cap_list_av2 identmsg_cap_list[] = {
	{ MAPI_CAP_CLIENT, "foxcomet.chat/identify-msg", NULL, &CLICAP_IDENTIFY_MSG },
	{ 0, NULL, NULL, NULL }
};
...
static void identmsg_outbound(void *data_)
{
	...
	if (IsIdentified(data->client))
		msgbuf_append_tag(msgbuf, "foxcomet.chat/identified", NULL, CLICAP_IDENTIFY_MSG);
}
